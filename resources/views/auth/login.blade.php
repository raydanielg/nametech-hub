                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        <div class="form-check d-flex align-items-center">
                            ...
                            <label class="form-check-label text-muted small mt-1" for="remember">
                    ...
                    <div class="position-relative text-center my-4">
                        ...
                        <span class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted small uppercase tracking-wider">or continue with</span>
                    </div>

                    <div class="row g-3">
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-light w-100 py-2 border shadow-sm social-btn" title="Google">
                                <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" width="20" height="20" alt="Google">
                            </button>
                        </div>
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-light w-100 py-2 border shadow-sm social-btn" title="GitHub">
                        ...
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-light w-100 py-2 border shadow-sm social-btn" title="SSO">
