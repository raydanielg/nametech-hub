...
@section('dashboard-title', 'Studio Invoices')
...
<div class="space-y-6 fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
            <p class="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Total Billed (TSh)</p>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                    <tr><td colspan="5" class="px-8 py-10 text-center text-gray-400 italic">No studio invoices found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
