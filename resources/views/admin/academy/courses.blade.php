...
<div class="space-y-8 fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.academy.courses.add') }}" class="px-5 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-bold hover:bg-gray-800 transition-colors flex items-center gap-2">
