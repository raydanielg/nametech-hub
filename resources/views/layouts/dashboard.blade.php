    ...
    <aside class="w-64 bg-white shadow-xl hidden md:flex flex-col border-r border-gray-200">
        <div class="p-6 flex items-center justify-between border-b border-gray-100">
            <div class="flex items-center space-x-3">
                <div class="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-indigo-200">
                    <span class="text-xl">N</span>
                </div>
                <div class="flex flex-col">
                    <span class="text-lg font-black text-gray-900 leading-none">NAMTECH</span>
                    <span class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mt-0.5">Innovation Hub</span>
                </div>
            </div>
        </div>
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center space-x-3 focus:outline-none group">
                        <div class="text-right hidden sm:block">
                            ...
                            <p class="text-[10px] font-bold text-indigo-600 uppercase tracking-tighter mt-1">{{ str_replace('_', ' ', auth()->user()->roles->first()->name ?? 'User') }}</p>
                        </div>
                        <div class="relative">
                            <img class="w-10 h-10 p-0.5 rounded-full ring-2 ring-indigo-500 group-hover:ring-indigo-600 transition-all object-cover" 
                    ...
                    <div x-show="open" 
                        ...
                        <a href="#" class="flex items-center space-x-3 px-4 py-2 text-sm font-bold text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
