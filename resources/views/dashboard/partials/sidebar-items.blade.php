...
@elseif($role === 'hub_director')
    <!-- Main Link for Hub Director -->
    <div class="mb-4">
        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-2">Main</p>
        <a href="{{ route('hub.dashboard.main') }}" class="flex items-center space-x-3 p-2 rounded-xl transition duration-150 {{ request()->routeIs('hub.dashboard.main') ? 'bg-pink-600 text-white shadow-lg' : 'text-gray-500 hover:bg-pink-50 hover:text-pink-600' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
            <span class="font-semibold text-sm">Dashboard</span>
        </a>
    </div>
...
@elseif($role === 'studio_director')
    <!-- Main Link for Studio Director -->
    <div class="mb-4">
        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-2">Main</p>
        <a href="{{ route('studio.dashboard.main') }}" class="flex items-center space-x-3 p-2 rounded-xl transition duration-150 {{ request()->routeIs('studio.dashboard.main') ? 'bg-pink-600 text-white shadow-lg' : 'text-gray-500 hover:bg-pink-50 hover:text-pink-600' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
            <span class="font-semibold text-sm">Dashboard</span>
        </a>
    </div>
...
@elseif($role === 'startup_founder')
    <!-- Main Link for Startup Founder -->
    <div class="mb-4">
        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-2">Main</p>
        <a href="{{ route('founder.dashboard.main') }}" class="flex items-center space-x-3 p-2 rounded-xl transition duration-150 {{ request()->routeIs('founder.dashboard.main') ? 'bg-pink-600 text-white shadow-lg' : 'text-gray-500 hover:bg-pink-50 hover:text-pink-600' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
            <span class="font-semibold text-sm">Dashboard</span>
        </a>
    </div>
